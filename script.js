class GiocoRunner {
    ...
    gameOver() {
        this.stato = 'gameOver';
        this.messaggioGameOver.innerHTML = `<span class="game-over-title">GAME OVER</span><br><span class="game-over-text">hai hittato il wallo all\'età di </span><br><span class="game-over-title">${this.annoCorrente} anni</span>`;
