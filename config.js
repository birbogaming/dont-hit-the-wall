const CONFIG = {
    ...
    // ============== COLLEZIONABILI ==============
    COLLEZIONABILE_PUNTI: 50,
    COLLEZIONABILE_LARGHEZZA: 100,
    COLLEZIONABILE_ALTEZZA: 100,
    COLLEZIONABILE_COLLIDER_LARGHEZZA: 50,
    COLLEZIONABILE_COLLIDER_ALTEZZA:80,
    COLLEZIONABILE_COLLIDER_OFFSET_X: 2.5,
    COLLEZIONABILE_COLLIDER_OFFSET_Y: 2.5,
    COLLEZIONABILE_POS_FONDO_MIN: 120,
    COLLEZIONABILE_POS_FONDO_MAX: 120,
    COLLEZIONABILE_START_X: 1200,
    INTERVALLO_CREAZIONE_COLLEZIONABILE_MIN_MS: 7500,
    INTERVALLO_CREAZIONE_COLLEZIONABILE_RANDOM_MS: 2500,
    SPRITE_COLLEZIONABILE_WINE_PATH: 'wine.svg',
};
